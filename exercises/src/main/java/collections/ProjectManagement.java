...
class Task {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass()) return false;
        Task task = (Task) o;
        return Objects.equals(uuid, task.uuid) && Objects.equals(description, task.description) && Objects.equals(hoursNeeded, task.hoursNeeded);
    }

    @Override
    public int hashCode() {
        return Objects.hash(uuid, description, hoursNeeded);
    }
}
